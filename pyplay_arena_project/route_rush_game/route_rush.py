...
background = pygame.image.load('assets/images/road_background.png')
...
class PlayerVehicle(Vehicle):
    ...
    def __init__(self, x, y):
        image = pygame.image.load('assets/images/red_car.png')
...
image_filenames = ['blue_pickup.png', 'black_car.png', 'yellow_car.png']
vehicle_images = []
for image_filename in image_filenames:
    image = pygame.image.load('assets/images/' + image_filename)
...
while running:
    ...
    if pygame.sprite.spritecollide(player, vehicle_group, True):
        crash_sound.play() # play the crash sound immediately
        gameover = True
